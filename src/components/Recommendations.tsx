...
const Recommendations = () => {
  ...
  return (
    <div
      ref={ref}
      className="w-full flex flex-col items-center justify-center gap-10 px-4 md:px-12 lg:px-24"
